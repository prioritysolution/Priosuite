...
const MemberProfileContainer = () => {
  ...
  return (
    <MemberProfile
      form={form}
      loading={loading}
      getMemberTypeLoading={getMemberTypeLoading}
      getMemberTypeData={getMemberTypeData}
      getRelationLoading={getRelationLoading}
      getGenderLoading={getGenderLoading}
      getCasteLoading={getCasteLoading}
      getReligionLoading={getReligionLoading}
      ...
      presentDistrictData={presentDistrictData}
      presentBlockData={presentBlockData}
      presentVillageData={presentVillageData}
      presentPoliceStationData={presentPoliceStationData}
      presentPostOfficeData={presentPostOfficeData}
      presentGetDistrictLoading={presentGetDistrictLoading}
      presentGetBlockLoading={presentGetBlockLoading}
      presentGetVillageLoading={presentGetVillageLoading}
      presentGetPoliceStationLoading={presentGetPoliceStationLoading}
      presentGetPostOfficeLoading={presentGetPostOfficeLoading}
    />
  );
};
