...
import InstitutionProfile from "@/components/membership/institutionProfile";

const InstitutionProfileContainer = () => {
  ...
  return (
    <InstitutionProfile
      ...
      getInstitutionLoading={getInstitutionLoading}
      handleMemberFormSubmit={handleMemberFormSubmit}
      officeDistrictData={officeDistrictData}
      officeBlockData={officeBlockData}
      officeVillageData={officeVillageData}
      officePoliceStationData={officePoliceStationData}
      officePostOfficeData={officePostOfficeData}
      officeGetDistrictLoading={officeGetDistrictLoading}
      officeGetBlockLoading={officeGetBlockLoading}
      officeGetVillageLoading={officeGetVillageLoading}
      officeGetPoliceStationLoading={officeGetPoliceStationLoading}
      officeGetPostOfficeLoading={officeGetPostOfficeLoading}
    />
  );
};
