            ...
            <div className="w-full flex gap-1">
              ...
              <p>
                {ledgerHeaderData?.Adm_Date
                  ? formatDateSafe(ledgerHeaderData?.Adm_Date, "dd-MM-yyyy")
                  : ""}
              </p>
            </div>
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Member No : </p>
              <p>{ledgerHeaderData?.Member_No || ""}</p>
            </div>
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Member Type : </p>
              <p>{ledgerHeaderData?.Member_Type || ""}</p>
            </div>
            <div className="w-full flex gap-1">
...
export default ShareLedgerPreview;
