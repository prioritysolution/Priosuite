...
import InvestmentLedgerPreview from "./InvestmentLedgerPreview";
...
const InvestmentLedger = ({
  ...
  const handleGeneratePDF = useReactToPrint({
    contentRef: printRef,
    documentTitle: `InvestmentLedger-${
            ...
            <div className="py-4 w-full flex flex-col gap-5  px-3 lg:px-0 overflow-y-hidden">
              <div className="w-full border border-dashed border-primary bg-secondary grid grid-cols-3 items-stretch gap-5 p-5 text-sm">
                <div className="space-y-2">
                  <p>
                    <span className="font-bold">Invest Type : </span>
                    <span>{ledgerHeaderData?.Invest_Type}</span>
                  </p>
                  ...
                  <p>
                    <span className="font-bold">No. of Installment : </span>
                    <span>{ledgerHeaderData?.No_Installment}</span>
                  </p>

                  <p>
                    <span className="font-bold">Mature Date : </span>
                    <span>
                      {ledgerHeaderData &&
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <span className="font-bold">Mature Value : </span>
                    <span>{ledgerHeaderData?.Mature_Val}</span>
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    <span className="font-bold">Investment Amt. : </span>
                    <span>{ledgerHeaderData?.Invest_Amt}</span>
                  </p>
