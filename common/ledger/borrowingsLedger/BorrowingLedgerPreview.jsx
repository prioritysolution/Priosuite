      ...
      {pages.map((pageRows, pageIndex) => (
        ...
        >
          ...
          <div className="text-xs flex flex-col gap-1 uppercase mb-1">
            ...
            <p>{regNo}</p>
            <p className="text-sm">
              Borrowing Ledger From {fromDate && format(fromDate, "dd-MM-yyyy")}{" "}
          ...
          <div className="h-[120px] w-full border border-black my-1 px-2 py-1 grid grid-cols-3 gap-1 text-xs text-start">
            ...
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Product Type : </p>
              <p>{ledgerHeaderData?.Prod_Type || ""}</p>
            </div>
            <div className="w-full flex gap-1">
            ...
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Total Disb. Amt. : </p>
              <p>{ledgerHeaderData?.Tot_Disb || ""}</p>
            </div>
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Disbursement Date : </p>
              <p>
            ...
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Rate Of Interest : </p>
              <p>{ledgerHeaderData?.Roi || ""}</p>
            </div>
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">OD. Rate : </p>
              <p>{ledgerHeaderData?.Od_Rate || ""}</p>
            </div>
            <div className="w-full flex gap-1">
            ...
            <div className="w-full flex gap-1">
              <p className="font-semibold text-nowrap">Due Date : </p>
              <p>
                {ledgerHeaderData?.Due_Date
...
export default BorrowingLedgerPreview;
