...
import { downloadInvestmentReportPdf } from "./buildInvestmentReportPdf";
...
const InvestmentReport = ({
  ...
  const handleDownloadPDF = async () => {
    ...
    const docTitle = `InvestmentDetailedList-${formatReportDate(fromDate)}-${formatReportDate(toDate)}`;
    const toastId = toast.loading("Preparing PDF…");

    try {
      setPdfLoading(true);
      await downloadInvestmentReportPdf({
        showData,
        tableData,
        fromDate,
        toDate,
            ...
            <div className="w-full flex flex-col border border-primary rounded-lg overflow-hidden">
              ...
              >
                ...
                <h3 className="text-xl font-semibold ">
                  {tEn("investment.investmentReport")}
                </h3>
                <div
