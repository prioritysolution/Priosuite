            ...
            <Table className="w-full border-collapse border border-black text-[11px] overflow-hidden">
              ...
              <TableHeader>
                <TableRow className="h-[50px] border-black">
                  ...
                  <TableHead className="text-black p-0 border-black border-l text-center w-[150px]">{t("membership.reports.print.customerName")}</TableHead>
                  <TableHead className="text-black p-0 border-black border-l text-center w-[150px]">{t("membership.reports.print.guardianName")}</TableHead>
                  ...
                  <TableHead className="text-black p-0 border-black border-l text-center w-[100px]">{t("membership.reports.print.admFees")}</TableHead>
                </TableRow>
              </TableHeader>
...
export default MemberRegisterPreview;
