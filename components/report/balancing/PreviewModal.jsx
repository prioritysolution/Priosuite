      ...
      {pages.map((pageRows, pageIndex) => (
        ...
        >
          ...
          <div className="flex-1 w-full">
            <Table
              className="w-full border-collapse border border-black text-[11px] overflow-hidden"
            ...
            >
              ...
              <TableHeader>
                <TableRow className="h-[60px]">
                  <TableHead
                    style={{ width: "25px" }}
                    className="text-black p-0 border-black text-center"
                  >
                    SL. NO.
                  </TableHead>
                  <TableHead
              ...
              <TableBody>
                {pageRows.map((row, index) => {
                  if (row.isSubHeader) {
                    ...
                    return (
                      <TableRow key={`sub-${index}`} className="h-[40px]">
                        <TableCell
                          colSpan={6}
