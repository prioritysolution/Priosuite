    ...
    >
      {reportPages.map((reportPage, pageIndex) => (
        <div
          ...
          className="w-full h-[297mm] flex flex-col text-center py-2 px-1 print:break-after-page bg-white overflow-hidden"
        >
          ...
          {/* TABLE */}
          <div className="flex-1 min-h-0">{renderTable(reportPage)}</div>

          {/* FOOTER */}
          <div className="shrink-0 w-full h-[40px] flex items-end justify-between text-xs relative px-1">
            <p>
