    ...
    <div className="p-6 space-y-6 overflow-x-hidden">
                ...
                kycList.map((item, index) => {
                  ...
                  return (
                    <TableRow key={index} className="hover:bg-gray-50/50">
                      ...
                      <TableCell>{formatDate(item.Appl_Date)}</TableCell>
                      <TableCell>{item.Loan_CaseNo || "—"}</TableCell>
                      <TableCell>{item.Full_Name || "—"}</TableCell>
                      <TableCell>{item.Prod_Name || "—"}</TableCell>
                      <TableCell>{item.Appl_Amount || "0.00"}</TableCell>
      ...
      {openModal && (
        <LoanActionModal
          ...
          getDeductionListForApproval={getDeductionListForApproval}
          loading={loading}
          {...actionModalProps}
        />
      )}
...
export default LoanapproalComponent;
